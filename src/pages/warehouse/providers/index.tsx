...
const Providers = () => {
  ...
  const initialColumns: GridColDef[] = [
    ...
    { field: 'phone', headerName: t.forms.client.phone, minWidth: 200, flex: 1 },
    { field: 'address', headerName: t.forms.client.address, minWidth: 200, flex: 1 },
    {
      field: 'actions',
    ...
    <>
      <Stack gap={4}>
        ...
        >
          ...
          >
            <Button variant='contained' sx={{ gap: 2 }} onClick={() => setModal('add-provider')}>
